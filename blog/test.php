...
if(isset($_POST['submit']))
{
	...
	if($er == 0)
	{$sql = "insert into city(name, countryid) values('".mysqli_real_escape_string($cn, strip_tags($name))."', ".$country.")";
		if(mysqli_query($cn, $sql))
		{
			print '<span class="success">City Saved</span>';
			$name = "";
			$country = "";
		}
		else
...
<div class="floatL cont_lft_side">
    <?if(isset($state_id)){?>
        <div style="padding:10px;">Your Selected value:
            <? echo $state_id;?>
        </div>
    <?}?>
